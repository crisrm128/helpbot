...
if("TRUE" STREQUAL "TRUE")
  set(obj_recognition_SOURCE_PREFIX /home/cristina/ws_helpbot/src/obj_recognition)
  set(obj_recognition_DEVEL_PREFIX /home/cristina/ws_helpbot/devel)
  ...
  set(obj_recognition_INSTALL_PREFIX /home/cristina/ws_helpbot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'obj_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cristina/ws_helpbot/src/obj_recognition/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT obj_recognition_NUM_DUMMY_TARGETS)
      set(obj_recognition_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::obj_recognition::wrapped-linker-option${obj_recognition_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR obj_recognition_NUM_DUMMY_TARGETS "${obj_recognition_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::obj_recognition::wrapped-linker-option${obj_recognition_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND obj_recognition_LIBRARIES "${interface_target_name}")
...
set(obj_recognition_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(obj_recognition_EXPORTED_TARGETS ${${obj_recognition_dep}_EXPORTED_TARGETS})
endforeach()
